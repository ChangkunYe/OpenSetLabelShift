# python scripts/osr/openmax/sweep_osr.py
import os
...
config = [
    ...
    [
        ...
        'resnet18_32x32', '/data2/u6469845/LOGS/Baselines/OpenOOD/osr/cifar50_seed1.ckpt'
    ],
    [
...
for [dataset, ood_dataset, network, pth] in [config[0]]:
