...
class OODEvaluator(BaseEvaluator):
    ...
    def _save_csv(self, metrics, dataset_name):
        [fpr, auroc, aupr_in, aupr_out, accuracy, ood_accuracy, all_accuracy] = metrics
        ...
        write_content = {
            ...
            'ID_ACC': '{:.2f}'.format(100 * accuracy),
            'OOD_ACC': '{:.2f}'.format(100 * ood_accuracy),
            'ALL_ACC': '{:.2f}'.format(100 * all_accuracy),
        }
        ...
        print('ID ACC: {:.2f}, OOD ACC: {:.2f}, ID + OOD ACC: {:.2f}'.format(
            100 * accuracy, 100 * ood_accuracy, 100 * all_accuracy))
        # print('-' * 70, flush=True)
        print('-' * 70, flush=True)
