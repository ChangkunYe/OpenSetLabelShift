...
# ckpt_lt_path2="/data2/u6469845/LOGS/Baselines/OpenOOD/cifar10_resnet18_32x32_base_e100_lr0.1_LT10_default"
#noise_gamma=0.2
...
ckpt_lt_path2="/data2/u6469845/LOGS/Baselines/OpenOOD/cifar100_resnet18_32x32_base_e100_lr0.1_LT10_default"
noise_gamma=0.1
...
#ckpt_lt_path2="/data2/u6469845/LOGS/Baselines/OpenOOD/imagenet200_resnet18_224x224_base_e90_lr0.1_LT10_default"
#noise_gamma=0.2
...
train_subset2="./configs/imb_subset/train/train_lt10.yml"
  ...
  do
    ...
    do
      ...
      python3 scripts/eval_ood.py  --id-data $dataset_name \
              --root $ckpt_lt_path2 \
              --save-score --save-csv \
              --train_subset_config $train_subset2 \
              --test_subset_config "$testset_prefix$path" \
              --postprocessor $pp --ood_ratio $ratio \
              --ood_noise_gamma $noise_gamma
    done
