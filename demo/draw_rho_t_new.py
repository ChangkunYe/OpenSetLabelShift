...
def main():
    info = [
        {
            "csv_prefix": "/Users/changkunye/Projects/LOGS/OpenOOD/CIFAR10-20240809/",
            "dataset": 'cifar10',
            "name": 'CIFAR10',
        },
        {
            "csv_prefix": "/Users/changkunye/Projects/LOGS/OpenOOD/CIFAR100-20240809/",
            "dataset": 'cifar100',
            'name': 'CIFAR100',
        }
    ]
                ...
                for p, name in zip(info, name_list):
                    ...
                    for method in methods:
                        ...
                        axes[0,i].plot(rho_t_gt, rho_t1_near, label=method_list[method] + r' $\hat{\rho}_t^*$',
                                     color=colors[k])
                        axes[0,i].plot(rho_t_gt, rho_t1_near, 'o', color=colors[k])
                        ...
                        axes[0,i].plot(rho_t_gt, rho_t0_near, '--', label=method_list[method] + r' $\hat{\rho}_t$',
                                     color=colors[k])
                        axes[0,i].plot(rho_t_gt, rho_t0_near, '*', color=colors[k])
                        ...
                        axes[1,i].plot(rho_t_gt, rho_t1_far, label=method_list[method] + r' $\hat{\rho}_t^*$',
                                     color=colors[k])
                        axes[1,i].plot(rho_t_gt, rho_t1_far, 'o', color=colors[k])
                        ...
                        axes[1,i].plot(rho_t_gt, rho_t0_far, '--', label=method_list[method] + r' $\hat{\rho}_t$',
                                     color=colors[k])
                        axes[1,i].plot(rho_t_gt, rho_t0_far, '*', color=colors[k])
...
def main2():
    ...
    for ood_shift_name in ood_shifts_names:
        ...
        plt.tight_layout()
        plt.savefig('./rho_t-imagenet200-%s.pdf' % ood_shift_name[0], bbox_extra_artists=(lgd,), bbox_inches='tight')
        plt.show()
        plt.close()
