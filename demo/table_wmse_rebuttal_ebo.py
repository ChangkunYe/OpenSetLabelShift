...
headings = ['\\multicolumn{2}{c|}{\multirow{2}{*}{BBSE}}  & Near & ',
            ...
            '\\multirow{10}{*}{\\textbf{ours}} & \\multirow{2}{*}{EBO}  &  Near &  ',
            '& & Far & ',
            ]
...
def main():
    info = [
        {
            "csv_prefix": "/Users/changkunye/Projects/LOGS/OpenOOD/CIFAR100-20250125/",
            "dataset": 'cifar100',
        }
    ]
    ...
    for data_info, name in zip(info_list, name_list):
        for id_shift in id_shifts:
            for ood_shift_type, ood_shift_name in zip(ood_shift_types, ood_shifts_names):
                write_path = "/Users/changkunye/Projects/LOGS/OpenOOD/all_tables/table_ebo_wmse_%s-%s-%s-%s.txt" % \
...
def main2():
    info = [
        {
            "csv_prefix": "/Users/changkunye/Projects/LOGS/OpenOOD/ImageNet200-20250126/",
            "dataset": 'imagenet200',
        },
    ]
